...
<head>
  ...
  <title>About - Bada O. David</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.php">Dave</a></h1>x
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>Hey! I'm Bada O. David a Website and Mobile Developer from Lagos, Nigeria</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            ...
            <p class="fst-italic">
              I am Full stack Web and Mobile designer/developer with years of experience in HTML, CSS, Bootstrap5, JavaScript, ReactJS, React Native, PHP and MySQL.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-rounded-right"></i> <strong>Birthday:</strong> 4 May</li>
                  <li><i class="bi bi-rounded-right"></i> <strong>Website:</strong> www.gitHub.com/BadaDavid2</li>
                  <li><i class="bi bi-rounded-right"></i> <strong>Phone:</strong> +234 806 1646 761</li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-rounded-right"></i> <strong>Age:</strong> 20</li>
                  <li><i class="bi bi-rounded-right"></i> <strong>City:</strong> Lekki, Lagos Nigeria</li>
                  <li><i class="bi bi-rounded-right"></i> <strong>Email:</strong> badadavid04@gmail.com</li>
                </ul>
              </div>
            </div>
            <p>
              I am Currently available for Freelance jobs and Internship opportunities
            </p>
          </div>
        </div>
    ...
    <section id="skills" class="skills">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Skills</h2>
          <p>My Skill Level in Html, CSS, Bootstrap5, JavaScript, ReactJS, React Native, Php, MySQL</p>
        </div>
    ...
    <section id="facts" class="facts">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Facts</h2>
          <p>
            I'm hardworking and I deliver jobs to clients before the due dates. I an my team are productive and multitask to achieve any goal given to us.
          </p>
        </div>
