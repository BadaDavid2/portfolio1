...
<head>
  ...
  <title>Services - Bada O. David</title>
    ...
    <section id="services" class="services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>I'm available for Internship programs, Job Opportunities and Tutoring. I'm also open for Mentorship</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <p>I'm open for Internship Programs; I love learning new things and developing myself.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red ">
              ...
              <p>I'm open for job opportunities relating to web and mobile design/development</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch aos-init aos-animate" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-orange">
              ...
              <p>I'm open for tutoring, Young Africans that are willing to learn and know more on web development can <a href="contact.php" style="color: rgba(16, 15, 67, 0.996);">contact me</a></p>
            </div>
          </div>
